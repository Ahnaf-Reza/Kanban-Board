...
export function Column({
  ...
  return (
    <section
      ref={setNodeRef}
      className="min-w-72 flex-shrink-0 space-y-3 rounded-xl border border-slate-200/70 bg-slate-100/80 p-3 shadow-sm backdrop-blur-sm transition-colors dark:border-slate-700/60 dark:bg-slate-800/70"
    >
